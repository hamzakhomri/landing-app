...
<body>
  ...
  <header>
    ...
    <nav class="mobile-navigation-menu has-scrollbar" v-if="mobileMenus[0].isActive" data-mobile-menu>
      ...
      <ul class="mobile-menu-category-list"  style="background-color: coral;" >
